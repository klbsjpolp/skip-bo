...
| AI coach and post-game summaries | `packages/game-core/src/lib/advice.ts`, `apps/web/src/hooks/useLocalAiInsights.ts`, `apps/web/src/hooks/useOnlineAiInsights.ts`, `apps/realtime-api/src/services/aiInsightsService.ts`, `apps/realtime-api/src/services/genAiProvider.ts` | [runtime-invariants.md](runtime-invariants.md), [../protocols/realtime-events.md](../protocols/realtime-events.md) |
